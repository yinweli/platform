...
//-----------------------------------------------------------------------------
C_NString::C_NString(IN const char *sz) : m_szString_m(sz ? sz : "") {}
//-----------------------------------------------------------------------------
C_NString::C_NString(IN const wchar_t *sz) : m_szString_m(sz ? _bstr_t(sz) : L"") {}
//-----------------------------------------------------------------------------
C_NString::C_NString(IN const std::string &sz) : m_szString_m(sz) {}
//-----------------------------------------------------------------------------
C_NString::C_NString(IN const std::wstring &sz) : m_szString_m(nsconv(sz)) {}
//-----------------------------------------------------------------------------
C_NString::C_NString(IN const _bstr_t &sz) : m_szString_m(static_cast<const char *>(sz)) {}
//-----------------------------------------------------------------------------
C_NString::~C_NString() {}
//-----------------------------------------------------------------------------
...
{
	if(sz)
		m_szString_m += nsconv(std::wstring(sz));
...
{
	m_szString_m += static_cast<const char *>(sz);
...
C_NString &C_NString::operator = (IN const wchar_t *sz)
{
	m_szString_m = sz ? nsconv(std::wstring(sz)) : "";
...
{
	return sz ? m_szString_m < nsconv(std::wstring(sz)) : false;
}
//-----------------------------------------------------------------------------
...
{
	return m_szString_m < static_cast<const char *>(sz);
}
//-----------------------------------------------------------------------------
bool C_NString::operator > (IN const C_NString &sz) const
{
...
void C_NString::copyto(OUT char *sz, IN unsigned long ulInputSize) const
{
	...
	strcpy_s(sz, ulInputSize, m_szString_m.c_str());
}
//-----------------------------------------------------------------------------
// 複製到wchar_t字串陣列
void C_NString::copyto(OUT wchar_t *sz, IN unsigned long ulInputSize) const
{
	...
	wcscpy_s(sz, ulInputSize, nsconv(m_szString_m).c_str());
}
//-----------------------------------------------------------------------------
// 以 char * 模式取得儲存的字串
